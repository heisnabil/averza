        ...
        {!showPreferences ? (
          <div>
            <div className="flex items-start justify-between gap-4 mb-4">
              <div className="flex items-center gap-2">
                <Shield className="w-5 h-5 text-[#650108] flex-shrink-0" />
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-[#650108] hover:bg-[#520006] text-white font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer"
              >
                Accept All
              </button>
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-[#8B1A22] font-semibold text-xs uppercase tracking-wider transition-colors border border-white/5 flex items-center justify-center gap-1 cursor-pointer"
                >
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Shield className="w-5 h-5 text-[#8B1A22]" />
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-start justify-between gap-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                <div className="flex gap-3">
                  <Shield className="w-4 h-4 text-[#650108] mt-0.5 flex-shrink-0" />
                  <div>
              ...
              >
                ...
                <input
                  ...
                  className="h-4 w-4 rounded border-white/20 bg-white/5 text-[#650108] focus:ring-[#650108] self-center cursor-pointer"
                />
              </label>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="py-2 rounded-xl bg-[#650108] hover:bg-[#520006] text-white font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer"
              >
                Save Choice
              </button>
            </div>
