    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 mt-28">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#650108] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top] [--tw-gradient-stops:from(#650108),_to(transparent)]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#650108] text-white [--conic-position:from_290deg_at_center_top] [--tw-gradient-stops:from(transparent),_to(#650108)]"
        >
        ...
        {/* Glow core — BLUE → MAROON */}
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#650108] opacity-50 blur-3xl"></div>

        {/* Light Glow Core — BLUE → LIGHTER MAROON */}
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#8B1A22] blur-2xl"
        ></motion.div>

        {/* Horizontal glowing line — BLUE → LIGHTER MAROON */}
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-[#8B1A22]"
        ></motion.div>
